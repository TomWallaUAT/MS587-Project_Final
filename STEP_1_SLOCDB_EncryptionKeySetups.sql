...
--RESTORE MASTER KEY FROM FILE
  Print 'Restoring Master Key From File: ''C:\temp\MasterKey_Bkup_MYKEY'''
  RESTORE MASTER KEY FROM FILE = 'C:\temp\MasterKey_Bkup_MYKEY'
	 DECRYPTION BY PASSWORD = 'SLOC1234Gr33nFr0g1!'
	 ENCRYPTION BY PASSWORD = 'SLOC1234Gr33nFr0g1!'
	--FORCE

  --ALTER MASTER KEY REGENERATE WITH ENCRYPTION BY PASSWORD = 'P@55W0rdM@ster'
  --OPEN MASTER KEY DECRYPTION BY PASSWORD = 'SLOC1234Gr33nFr0g1!'
  
  USE SLOC_DB;
--BACKUP MASTER KEY TO FILE
  Print 'Backing up Master Key to File: ''C:\temp\MasterKey_Bkup_MYKEY'''
  BACKUP MASTER KEY TO FILE = 'C:\temp\MasterKey_Bkup_MYKEY'
	 Encryption by password ='SLOC1234Gr33nFr0g1!'
...
-- ====================================================================================================
-- SCRIPT CHECK AND SETUP of Master Key and Symmetric Key
-- ====================================================================================================
...
CDB_ASymKey;
 (Select * from sys.symmetric_keys where name = 'SLOCDB_SymKey')
BEGIN
	PRINT 'Creating Symmetric Key: SLOCDB_SymKey'
	CREATE SYMMETRIC KEY SLOCDB_SymKey
	--AUTHORIZATION dbo
